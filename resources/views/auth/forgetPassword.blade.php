...
@section('content')
    <div id="forgotPasswordForm" class="space-y-6 w-10/12">
        <div>
            <h2 class="text-center text-3xl font-bold text-cyan-800">Reset Password</h2>
            ...
            <div class="form-group mb-6">
                <div class="mt-1 relative">
                    <input id="email" type="email"
                        class="mt-1 shadow-cyan-800/75 @error('email') border-t border-l border-r border-red-500 @enderror appearance-none block w-full px-3 py-2 border-0 rounded-md shadow-md placeholder:text-slate-400 hover:shadow-cyan-500 focus:outline-none focus:border-b-0 focus:shadow-cyan-500 transition-all ease-in-out delay-75"
