                ...
                <div class="form-group mb-6">
                    <div class="mt-1 relative">
                        <input type="text" id="verification_code" name="code" maxlength="6"
                            class="mb-2 shadow-cyan-800/75 appearance-none block w-full px-3 py-3 border-0 rounded-md shadow-md placeholder:text-slate-400 hover:shadow-cyan-500 focus:outline-none focus:border-b-0 focus:shadow-cyan-500 transition-all ease-in-out delay-75"
